...
var wame = 'https://github.com/juviann'
var youtube = 'https://youtube.com/channel/UCL-1ccm0on-hBuh2GWLaZRA'
...
async function sendButLoc(from) {
        ...
        var button = [
		{ urlButton: { displayText: `Source Code`, url : `https://github.com/juviann/BOTMD` } },
...
🛒 𝗦𝗲𝗹𝗹 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝘆
 ...
 × ${prefix}sellemas
 × ${prefix}selldiamond`
      neo.sendMessage(from, { caption: hg, location: { jpegThumbnail: thumbrpg }, templateButtons: button, footer: `Rpg Game By Juvian`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
「 PROFILE 」
 ...
 • Xp :  ${getLevelingXp(sender)}/${reqXp}
「 RPG GAME 」`
        neo.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgjoinrpg }, templateButtons: button, footer: `Rpg Game By Juvian`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
addDm(sender, d)
        ...
        neo.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgslime }, templateButtons: button, footer: `Rpg Game By Juvian`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
neo.sendMessage(from, { caption: hg, location: { jpegThumbnail: imggoblin }, templateButtons: button, footer: `Rpg Game By Juv`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: thumbnail, surface: 200, message: `${global.creator}`, orderTitle: 'Please Subscribe Youtube Juvian Senpai', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
switch(command) {
case 'menu': case 'help':{
 if (!isRegis) return m.reply(mess.noRegis)
...
♯ *Github : ${global.githubname}*
♯ *Email : ${global.email}*
──────────────────
${SK} _*INFO CREATOR*_
♯ *Nama : Juvian Official*
♯ *Number : +6282362285077*
♯ *Made in : Indonesia, Medan*
♯ *Hobi : Baca Manhua Kultivasi Awoawok*
──────────────────`
let btn = [{
urlButton: {
displayText: 'Source Code',
url: 'https://github.com/gatau'
}
}, {
urlButton: {
displayText: 'My Website',
url: 'https://github.com/juviann'
}
}, {
quickReplyButton: {
...
urlButton: {
displayText: 'Source Code',
url: 'https://github.com/DikaArdnt/neo-Morou'
}
}, {
quickReplyButton: {
displayText: 'List Menu',
...
teks =`
_*Script Bot :*_
https://chat.whatsapp.com/FvVp4ePuehu56rzaUOgNiZ

_*Creator : VIANNBOT-MD*_
_*Youtube : Juvian Official*_
_*Whatsapp : 0823-6228-5077*_

_*Link Base Script :*_
https://github.com/juviann
`
m.reply(teks)
break
...
teks = "*© Created By Juvian Official*"
...
hydratedFooterText: 'Created By Viann Botz',
hydratedButtons: [{
urlButton: {
...
url: 'https://chat.whatsapp.com/FvVp4ePuehu56rzaUOgNiZ'
}
}, {
urlButton: {
displayText: 'Source Code',
...
case 'nomerhoki': case 'nomorhoki': {
			...
			case 'ramalanjodoh': case 'ramaljodoh': {
                if (!text) throw `Example : ${prefix + command} Juvian, 12, 1, 2004, Clara, 22, 2, 2004`
            ...
            break
            case 'artinama': {
                if (!text) throw `Example : ${prefix + command} Juvian`
            ...
            case 'kecocokannama': case 'cocoknama': {
                if (!text) throw `Example : ${prefix + command} Juvian, 12, 1, 2004`
            ...
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                if (!text) throw `Example : ${prefix + command} Juvian|Clara`
...
break
            ...
            break
            case 'fengshui': {
                if (!text) throw `Example : ${prefix + command} Juvian, 1, 2004\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
break
            case 'peruntungan': {
                if (!text) throw `Example : ${prefix + command} Juvian, 12, 1, 2004, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
urlButton: {
displayText: 'Source Code',
url: 'https://github.com/juviann/BOTMD'
}
}, {
quickReplyButton: {
...
neo.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "Click Here!", "Fitur Nulis By Juvian ", fejfjej, { quoted: m })
break
...
urlButton: {
displayText: 'Source Code',
url: 'https://github.com/Juvian/BOTMD'
}
}, {
urlButton: {
...
urlButton: {
displayText: 'My Youtube',
url: 'https://youtube.com/channel/UCL-1ccm0on-hBuh2GWLaZRA'
}
}, {
quickReplyButton: {
displayText: 'Status Bot',
...
url: `https://api.whatsapp.com/send/?phone=6282362285077&text=KonfirmasiTopUpFreeFire\n%20ID%20${txt1}%20Nominal%205 dm💎`
}
}]
}
}
...
url: `https://api.whatsapp.com/send/?phone=6282362285077&text=Kak%20Mau%20Convert%20Saldo%20Dana`
}
}]
neo.send5ButImg(m.chat, cv1, `Convert Saldo By Juvian`, qris, btnC)
}
break
...
urlButton: {
displayText: 'Konfirmasi Transfer',
url: `https://api.whatsapp.com/send/?phone=6282362285077&text=Kak%20Mau%20Convert%20Saldo%20Gopay`
}
}]
neo.send5ButImg(m.chat, cv2, `Convert Saldo By Juviann`, qris, btnC)
}
break
case 'cv3':{
let btnC = [{
urlButton: {
displayText: 'Konfirmasi Transfer',
url: `https://api.whatsapp.com/send/?phone=6282362285077&text=Kak%20Mau%20Convert%20Saldo%20Ovo`
}
}]
neo.send5ButImg(m.chat, cv3, `Convert Saldo By Juvian`, qris, btnC)
}
break
case 'cv4':{
let btnC = [{
urlButton: {
displayText: 'Konfirmasi Transfer',
url: `https://api.whatsapp.com/send/?phone=6282362285077&text=Kak%20Mau%20Convert%20Saldo%20Link%20Aja`
}
}]
neo.send5ButImg(m.chat, cv4, `Convert Saldo By Juvian`, qris, btnC)
}
break
case 'quest':
let sectionnya= [
